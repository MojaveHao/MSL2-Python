...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.motd = QLineEdit(self.widget_2)
        self.motd.setObjectName(u"motd")

        self.gridLayout_2.addWidget(self.motd, 7, 15, 1, 3)

        self.n_1 = QLabel(self.widget_2)
        self.n_1.setObjectName(u"n_1")

        self.gridLayout_2.addWidget(self.n_1, 3, 0, 1, 2)

        self.max_player = QLineEdit(self.widget_2)
        self.max_player.setObjectName(u"max_player")

        self.gridLayout_2.addWidget(self.max_player, 6, 8, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.server_port, 6, 15, 1, 3)

        self.n_11 = QLabel(self.widget_2)
        self.n_11.setObjectName(u"n_11")

        self.gridLayout_2.addWidget(self.n_11, 7, 5, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.cbox_using_java, 1, 1, 2, 5)

        self.n_5 = QLabel(self.widget_2)
        self.n_5.setObjectName(u"n_5")

        self.gridLayout_2.addWidget(self.n_5, 5, 10, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.widget_3, 8, 0, 1, 18)

        self.n_9 = QLabel(self.widget_2)
        self.n_9.setObjectName(u"n_9")

        self.gridLayout_2.addWidget(self.n_9, 6, 12, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.pbtn_download_server, 1, 13, 2, 5)

        self.max_ram = QSpinBox(self.widget_2)
        self.max_ram.setObjectName(u"max_ram")
        self.max_ram.setMinimum(1)
        self.max_ram.setMaximum(256)

        self.gridLayout_2.addWidget(self.max_ram, 5, 7, 1, 3)

        self.cbox_pvp = QComboBox(self.widget_2)
        self.cbox_pvp.addItem("")
        self.cbox_pvp.addItem("")
        self.cbox_pvp.setObjectName(u"cbox_pvp")
        self.cbox_pvp.setCursor(QCursor(Qt.PointingHandCursor))

        self.gridLayout_2.addWidget(self.cbox_pvp, 7, 1, 1, 4)

        self.n_10 = QLabel(self.widget_2)
        self.n_10.setObjectName(u"n_10")

        self.gridLayout_2.addWidget(self.n_10, 7, 0, 1, 1)

        self.lb_path = QLabel(self.widget_2)
        self.lb_path.setObjectName(u"lb_path")
        self.lb_path.setAlignment(Qt.AlignCenter)

        self.gridLayout_2.addWidget(self.lb_path, 3, 2, 1, 15)

        self.n_12 = QLabel(self.widget_2)
        self.n_12.setObjectName(u"n_12")

        self.gridLayout_2.addWidget(self.n_12, 7, 12, 1, 3)

        self.pbtn_dis_log4j2 = QPushButton(self.widget_2)
        self.pbtn_dis_log4j2.setObjectName(u"pbtn_dis_log4j2")
        self.pbtn_dis_log4j2.setCursor(QCursor(Qt.PointingHandCursor))

        self.gridLayout_2.addWidget(self.pbtn_dis_log4j2, 5, 11, 1, 7)

        self.n_4 = QLabel(self.widget_2)
        self.n_4.setObjectName(u"n_4")

        self.gridLayout_2.addWidget(self.n_4, 5, 5, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.pbtn_select_path, 3, 17, 1, 1)

        self.min_ram = QSpinBox(self.widget_2)
        self.min_ram.setObjectName(u"min_ram")
        self.min_ram.setMinimum(1)
        self.min_ram.setMaximum(256)

        self.gridLayout_2.addWidget(self.min_ram, 5, 1, 1, 2)

        self.n_3 = QLabel(self.widget_2)
        self.n_3.setObjectName(u"n_3")

        self.gridLayout_2.addWidget(self.n_3, 5, 0, 1, 1)

        self.n_6 = QLabel(self.widget_2)
        self.n_6.setObjectName(u"n_6")

        self.gridLayout_2.addWidget(self.n_6, 6, 5, 1, 3)

        self.cbox_command_block = QComboBox(self.widget_2)
        ...
        self.gridLayout_2.addWidget(self.cbox_command_block, 7, 8, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.pbtn_start_server, 0, 0, 1, 18)
        ...
        self.gridLayout_2.addWidget(self.pbtn_show_java_path, 1, 6, 2, 7)

        self.n_7 = QLabel(self.widget_2)
        self.n_7.setObjectName(u"n_7")

        self.gridLayout_2.addWidget(self.n_7, 6, 0, 1, 1)

        self.cbox_mojang = QComboBox(self.widget_2)
        ...
        self.gridLayout_2.addWidget(self.cbox_mojang, 6, 1, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.widget_4, 4, 0, 1, 18)
