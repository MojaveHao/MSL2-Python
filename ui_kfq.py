...
from PySide6.QtWidgets import (QComboBox, QFrame, QGridLayout,
                               QHBoxLayout, QLabel, QLineEdit, QPushButton, QSizePolicy, QSpinBox, QVBoxLayout,
                               QWidget)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.widget_3, 8, 1, 1, 9)
        ...
        self.gridLayout_2.addWidget(self.pbtn_start_server, 0, 1, 1, 9)
        ...
        self.gridLayout_2.addWidget(self.pbtn_download_server, 1, 6, 2, 4)
        ...
        self.gridLayout_2.addWidget(self.widget_4, 4, 1, 1, 9)
        
        self.n_1 = QLabel(self.widget_2)
        self.n_1.setObjectName(u"n_1")
        
        self.gridLayout_2.addWidget(self.n_1, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.widget_5, 6, 1, 2, 3)
        
        self.n_8 = QLabel(self.widget_2)
        self.n_8.setObjectName(u"n_8")
        
        self.gridLayout_2.addWidget(self.n_8, 1, 1, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.pbtn_select_path, 3, 9, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.widget_6, 6, 4, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.pbtn_show_java_path, 1, 4, 2, 2)
        ...
        self.gridLayout_2.addWidget(self.cbox_using_java, 1, 2, 2, 2)
        
        self.gridLayout.addWidget(self.widget_2, 0, 2, 1, 1)
        
        self.line_5 = QFrame(self.centralwidget)
        self.line_5.setObjectName(u"line_5")
        self.line_5.setMinimumSize(QSize(1, 0))
        self.line_5.setMaximumSize(QSize(1, 16777215))
        self.line_5.setStyleSheet(
            u"Line{background-color: rgb(66, 66, 66);border:1px solid rgb(66, 66, 66);border:none;}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.n_11.setText(
            QCoreApplication.translate("MainWindow", u"\u662f\u5426\u542f\u7528\u547d\u4ee4\u65b9\u5757\uff1a", None))
